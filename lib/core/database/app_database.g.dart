...
class $$UsersTableTableManager
    extends
        RootTableManager<
          ...
          User,
          PrefetchHooks Function({bool walletsRefs, bool budgetsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({walletsRefs = false, budgetsRefs = false}) {
                ...
                return [
                  if (walletsRefs)
                    await $_getPrefetchedData<User, $UsersTable, Wallet>(
                      currentTable: table,
                      referencedTable: $$UsersTableReferences._walletsRefsTable(
                        db,
                      ),
